...
int _tmain(int argc, wchar_t *argv[])
{
	...
	if(t==p)
		...
		num_of_comb = Factorial(t)/(Factorial(p)*(Factorial(t-p)));  //broj kombincija, za ispitivanje kolona
	...
	MultipleCombinations(0,2,col_elements, combination, &index); // u multiple_combinations, sve kombinacije reda 2 od n elemenata bez ponavljanja
